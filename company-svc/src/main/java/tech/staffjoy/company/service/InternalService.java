...
import tech.staffjoy.company.dto.GrowthGraphResponse;
...
public class InternalService {
    ...
    public GrowthGraphResponse getGrowthGraph() {
        ...
        GrowthGraphResponse response = GrowthGraphResponse.builder().peopleScheduledPerWeek(stuff)
                .peopleOnShift(peopleOnShifts).build();
