...
import tech.staffjoy.bot.client.BotClient;
...
@EnableFeignClients(basePackages = {"tech.staffjoy.account.client"})
...
public class AccountControllerTest {
    ...
    public void testChangeEmail() {
        ...
        CreateAccountRequest createAccountRequest = CreateAccountRequest.builder()
                ...
                .build();
        // create one account
        ResponseEntity<AccountDto> createAccountReponse = accountClient.createAccount(AuthConstant.AUTHORIZATION_WWW_SERVICE, createAccountRequest);
        assertThat(!createAccountReponse.getStatusCode().isError()).isTrue();
        AccountDto accountDto = createAccountReponse.getBody();
        ...
        EmailConfirmation emailConfirmation = EmailConfirmation.builder()
                ...
                .email(changedEmail)
                .build();
        ResponseEntity<String> changeEmailResponse = accountClient.changeEmail(AuthConstant.AUTHORIZATION_WWW_SERVICE, emailConfirmation);
        assertThat(!changeEmailResponse.getStatusCode().isError()).isTrue();

        // verify email changed and account activated
        GetOrCreateRequest getOrCreateRequest = GetOrCreateRequest.builder()
                .email(changedEmail)
                .build();
        createAccountReponse = accountClient.getOrCreateAccount(AuthConstant.AUTHORIZATION_WWW_SERVICE, getOrCreateRequest);
        AccountDto foundAccountDto = createAccountReponse.getBody();
        ...
        emailConfirmation = EmailConfirmation.builder()
                ...
                .email(changedEmail)
                .build();
        changeEmailResponse = accountClient.changeEmail(AuthConstant.AUTHORIZATION_WWW_SERVICE, emailConfirmation);
        assertThat(!changeEmailResponse.getStatusCode().isError()).isFalse();
//        assertThat(baseResponse.getCode()).isEqualTo(ResultCode.NOT_FOUND);
    ...
    public void testRequestEmailChange() {
        ...
        CreateAccountRequest createAccountRequest = CreateAccountRequest.builder()
                ...
                .build();
        // create one account
        ResponseEntity<AccountDto> createAccountResponse = accountClient.createAccount(AuthConstant.AUTHORIZATION_WWW_SERVICE, createAccountRequest);
        assertThat(!createAccountResponse.getStatusCode().isError()).isTrue();
        AccountDto accountDto = createAccountResponse.getBody();
        ...
        EmailChangeRequest emailChangeRequest = EmailChangeRequest.builder()
                ...
                .userId(accountDto.getId())
                .build();
        ResponseEntity<String> requestEmailChangeResponse = accountClient.requestEmailChange(AuthConstant.AUTHORIZATION_SUPPORT_USER, emailChangeRequest);
        assertThat(!requestEmailChangeResponse.getStatusCode().isError()).isTrue();
