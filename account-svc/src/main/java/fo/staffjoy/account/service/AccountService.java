package fo.staffjoy.account.service;
...
import fo.staffjoy.account.model.Account;
import fo.staffjoy.account.model.AccountSecret;
import fo.staffjoy.account.reporsitory.AccountRepository;
import fo.staffjoy.account.reporsitory.AccountSecretRepository;
import fo.staffjoy.account.service.helper.HelpService;
...
import fo.staffjoy.common.util.Helper;
...
public class AccountService {
    ...
    private final fo.staffjoy.account.properties.AppProps appProps;
